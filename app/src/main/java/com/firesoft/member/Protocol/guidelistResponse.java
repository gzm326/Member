 ...
 */
@Table(name = "guidelistResponse")
public class guidelistResponse extends DataBaseModel {
    public ArrayList<SIMPLE_GUIDE> guides = new ArrayList<SIMPLE_GUIDE>();
    ...
    public void  fromJson(JSONObject jsonObject)  throws JSONException
    {
        ...
        subItemArray = jsonObject.optJSONArray("guides");
        ...
        if(null != subItemArray)
        {
            for(int i = 0;i < subItemArray.length();i++)
            {
                ...
                SIMPLE_GUIDE subItem = new SIMPLE_GUIDE();
                subItem.fromJson(subItemObject);
                this.guides.add(subItem);
            }
        }
    ...
    public JSONObject  toJson() throws JSONException
    {
        ...
        {
            SIMPLE_GUIDE itemData =guides.get(i);
            JSONObject itemJSONObject = itemData.toJson();
            itemJSONArray.put(itemJSONObject);
        }

        localItemObject.put("total", total);
        localItemObject.put("guides", itemJSONArray);
